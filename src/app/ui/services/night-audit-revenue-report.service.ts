...
export class NightAuditRevenueReportService {
  ...
  getSearchedDataList(options: any) {
    ...
    let searchUrl = servUrl + 'Report/NightAudit/RevenueReport?hotelId='+ this.userHotelID+'&businessDate='+options.tcDatePickerStart;
