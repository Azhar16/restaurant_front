...
export class MtdYtdNightauditReportService {
  userHotelID: String;
  ...
  getSearchedDataList(options: any) {
    ...
    let searchrequestUrl = servUrl + 'Report/NightAudit/MTDYTDReport?hotelId='+ this.userHotelID+'&businessDate='+options.tcDatePickerStart;
