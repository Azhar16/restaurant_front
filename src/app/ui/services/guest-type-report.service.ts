...
export class GuestTypeReportService {
  ...
  getSearchedDataList(options: any) {
    ...
    let searchUrl = servUrl + 'Report/guestReport/guestTypeReport?hotelId='+ this.userHotelID+'&searchBasis='+options.radioOptions+'&startDate='+options.tcDatePickerStart+'&endDate='+options.tcDatePickerEnd;
